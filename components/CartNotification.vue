    ...
    >
      ...
      >
        ...
        <button
          ...
          class="w-6 h-6 flex items-center justify-center flex-shrink-0 text-gray-400 hover:text-textMain transition-colors cursor-pointer bg-transparent border-none rounded-full hover:bg-gray-100"
        >
